						...
						<table class="teacherReport-tableAll">
							...
							<c:forEach items="${voList}" var="vo">
								<tr>
									...
									<td><a href="teacherCancel?mId=${vo.getM_r_receiveid()}&mNickname=${vo.getM_r_receiveNickname()}&tNo=${vo.getT_no()}">자격 박탈</a></td>
								</tr>
							</c:forEach>
						</table>
					</div>
