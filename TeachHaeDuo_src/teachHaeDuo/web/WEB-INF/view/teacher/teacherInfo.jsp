		...
		<div class="report_content">
			...
			<!-- <form> -->
				...
				<div class="report_input">
					...
					<textarea cols="35" rows="10" name="m_r_content" id="m_r_content" maxlength="1000" placeholder="신고 내용을 입력해주세요.(최대 한글 1000자)" required></textarea>
				</div>
	...
	<div class="modal message">
		<div class="message_content">
			...
			<div class="message_input">
				...
				<textarea cols="35" rows="10" name="alarm_content" id="alarm_content" maxlength="200" placeholder="쪽지 내용을 입력해주세요.(최대 한글 200자)"></textarea>
			</div>
	...
	<div class="modal review">
		<div class="review_content">
			...
			<div class="review_input">
				...
				<textarea cols="35" rows="10" name="t_r_content" id="t_r_content" maxlength="100" placeholder="리뷰를 입력해주세요.(최대 한글 100자)" required></textarea>
			</div>
								...
								<c:choose>
									<c:when test="${empty tvo.like}">
										...
										<button type="button" id="btn_like" class="btn3_1">
											<img src="<%=request.getContextPath()%>/resources/icons/like.png">찜
										</button>
									</c:when>
									<c:when test="${not empty tvo.like}">
										...
										<button id="btn_cancle_like" class="btn3_1">
											<img src="<%=request.getContextPath()%>/resources/icons/like_color.png">찜
										</button>
									</c:when>
								</c:choose>
