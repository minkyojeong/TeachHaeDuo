...
<body>
			...
			<div class="main_teacher">
				...
				<input id="tab7" type="radio" name="tabs"> <label for="tab7">기타</label>
					...
					<div class="choice_option">
						...
						</select> <select name="area" id="area_search">
	...
	<div class="btns_on_off">
						<button type="button" id="btn_online"><img src="${pageContext.request.contextPath}/resources/icons/online.png">
				...
				<div class="page_wrap">
					<div class="page_nation">
						<a class="arrow prev" href="#"><img
							src="${pageContext.request.contextPath}/resources/icons/page_prev.png"></a>
						<a href="#" class="active">1</a> <a href="#">2</a> <a href="#">3</a>
						<a class="arrow next" href="#"><img
							src="${pageContext.request.contextPath}/resources/icons/page_next.png"></a>
					</div>
				</div>
		</div>
	...
	if(object_list == "통합"){ object_list = "";}
				searchTeacher();
			});
			$(".btn_like").on("click", function(){
			    if($(this).hasClass("enabled")){
			    	$(this).html('<img src="${pageContext.request.contextPath}/resources/icons/like.png">찜');
			        $(this).removeClass("enabled");
			        liked = "";
			    }else{
			    	$(this).html('<img src="${pageContext.request.contextPath}/resources/icons/like_color.png">찜');
			...
			$(".btn_recruit").on("click", function(){
			    if($(this).hasClass("enabled")){
			    	$(this).html('<img src="${pageContext.request.contextPath}/resources/icons/recruit.png">모집상태');
			        $(this).removeClass("enabled");
			        t_permit_yn = "";
			    }else{
			    	$(this).html('<img src="${pageContext.request.contextPath}/resources/icons/recruit.png">모집중');
			        $(this).addClass("enabled");
			        t_permit_yn = 'Y';
			    }
				searchTeacher();
			...
			$(".btn_call").on("click", function(){
			    if($(this).hasClass("enabled")){
			    	$(this).html('<img src="${pageContext.request.contextPath}/resources/icons/smartphone.png">통화허용');
			        $(this).removeClass("enabled");
			        t_permit_yn = "";
			    }else{
			    	$(this).html('<img src="${pageContext.request.contextPath}/resources/icons/smartphone.png">통화가능');
			        $(this).addClass("enabled");
			        t_permit_yn = 'Y';
			    }
				searchTeacher();
			...
			$(".btn_online").on("click", function(){
			    if($(this).hasClass("enabled")){
			    	$(this).html('<img src="${pageContext.request.contextPath}/resources/icons/online.png">온라인 교습');
			        $(this).removeClass("enabled");
			        online_yna = "";
			    }else{
			    	$(this).html('<img src="${pageContext.request.contextPath}/resources/icons/online.png">온라인 교습');
			...
			$(".btn_offline").on("click", function(){
			    if($(this).hasClass("enabled")){
			    	$(this).html('<img src="${pageContext.request.contextPath}/resources/icons/offline.png">오프라인 교습');
			        $(this).removeClass("enabled");
			        online_yna = "";
			    }else{
			    	$(this).html('<img src="${pageContext.request.contextPath}/resources/icons/offline.png">오프라인 교습');
