...
COMMENT ON COLUMN "T_PROFILE"."ONLINE_YN" IS '온라인Y, 오프라인N';
...
CREATE TABLE "CS_NOTICE" (
	...
	"NOTICE_CONTENT"	VARCHER2(3000)		NOT NULL,
	"NOTICE_CNT"	NUMBER	DEFAULT 0	NOT NULL,
	"NOTICE_WRITE_DATE"	TIMPSTAMP	DEFAULT SYSTIMESTAMP	NOT NULL,
...
CREATE TABLE "CS_FAQ" (
	...
	"FAQ_QUESTION"	VARCHER2(300)		NOT NULL,
	"FAQ_ANSWER"	VARCHER(3000)		NOT NULL,
	"ADMIN_ID"	VARCHAR2(15)		NOT NULL,
...
CREATE TABLE "BOARD_REPORT" (
	...
	"B_NO"	NUMBER		NOT NULL,
	"B_R_CATEGORY"	VARCHER2(100)		NOT NULL,
	"B_R_WRITER"	VARCHER2(60)		NOT NULL,
	"B_R_WRITE_DATE"	TIMPSTAMP	DEFAULT SYSTIMESTAMP	NOT NULL
);
...
COMMENT ON COLUMN "ACTIVITY_AREA"."T_NO" IS 'T_PROFILE(T_NO)';

COMMENT ON COLUMN "ACTIVITY_AREA"."AREA_CODE" IS 'AREA(AREA_CODE)';
...
ALTER TABLE "ACTIVITY_AREA" ADD CONSTRAINT "FK_T_PROFILE_TO_ACTIVITY_AREA_1" FOREIGN KEY (
	"T_NO"
)
REFERENCES "T_PROFILE" (
	"T_NO"
...
ALTER TABLE "ACTIVITY_AREA" ADD CONSTRAINT "FK_AREA_TO_ACTIVITY_AREA_1" FOREIGN KEY (
	"AREA_CODE"
)
REFERENCES "AREA" (
	"AREA_CODE"
