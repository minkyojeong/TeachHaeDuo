...
CREATE TABLE "ALARM" (
	...
	"ALARM_SENDID"	VARCHAR2(60)		NOT NULL,
	"ALARM_RECEIVEID"	VARCHAR2(60)		NOT NULL,
	"M_ID"	VARCHAR2(15)		NOT NULL
);
...
CREATE TABLE "T_PROFILE" (
	...
	"T_MAJOR"	VARCHAR2(100)	DEFAULT '미등록'	NOT NULL,
	"ONLINE_YNA"	CHAR(1)	DEFAULT 'D'	NOT NULL,
	...
	"T_PROFILE_YN"	CHAR(1)	DEFAULT 'N'	NOT NULL,
...
COMMENT ON COLUMN "T_PROFILE"."T_APPROVAL" IS '승인Y, 승인아니면N,비승인처리:D';

COMMENT ON COLUMN "T_PROFILE"."T_PROFILE_YN" IS '등록Y, 아니면N';
